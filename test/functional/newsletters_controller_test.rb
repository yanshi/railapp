...
class NewslettersControllerTest < ActionController::TestCase
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post :create, newsletter: { body: @newsletter.body, created_at: @newsletter.created_at, sent: @newsletter.sent, subject: @newsletter.subject, updated_at: @newsletter.updated_at }
    end
  ...
  test "should update newsletter" do
    put :update, id: @newsletter, newsletter: { body: @newsletter.body, created_at: @newsletter.created_at, sent: @newsletter.sent, subject: @newsletter.subject, updated_at: @newsletter.updated_at }
    assert_redirected_to newsletter_path(assigns(:newsletter))
  end
